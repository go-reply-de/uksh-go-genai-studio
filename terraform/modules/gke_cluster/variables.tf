...
variable "librechat_credentials_env_keys" {
  type    = list(string)
  default = ["CREDS_IV", "CREDS_KEY", "GOOGLE_CLIENT_ID", "GOOGLE_CLIENT_SECRET", "JWT_REFRESH_SECRET", "JWT_SECRET", "MEILI_MASTER_KEY", "POSTGRES_DB", "POSTGRES_PASSWORD", "POSTGRES_USER", "SONAR_HOST", "SONAR_LOGIN", "OPENAI_API_KEY"]
}